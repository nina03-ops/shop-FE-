...
export class AuthService {
  ...
  constructor() {
    this._properties = {
      clientID: "6vdwKiiZCzvO05nVgb6YRDolckebvK48",
      domain: "https://dev-6lephhuo.us.auth0.com/",
  ...
  public checkSession(): Promise<boolean> {
    return new Promise<boolean>((resolve, reject) => {
      ...
      this._auth0Client.checkSession(this._properties, async (error: any, authResult: any) => {
